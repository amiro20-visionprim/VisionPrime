			...
			array(
				...
				'items' => array(
					array(
						...
						'title' => 'سازمان‌ها و برندها',
						'page'  => 'vpos-brands',
						'perm'  => 'brand:view',
						'desc'  => 'هر برند یک سایت مستقل در شبکه وردپرس است؛ داده‌های مشتری، کیف پول و سفارش هر برند کاملاً از برندهای دیگر جداست.',
						'steps' => array(
							'برند جدید را از «ایجاد برند» بسازید؛ یک سایت جدید به‌صورت خودکار ساخته می‌شود.',
							'برای مدیریت یک برند مشخص، وارد سایت همان برند شوید.',
							'دسترسی به مدیریت سازمان‌ها فقط برای مدیر کل شبکه است.',
						),
					),
					array(
						...
						'page'  => 'vpos-branches',
						'perm'  => 'branch:view',
						'desc'  => 'شعبه‌ها زیرمجموعه یک برند هستند و دسترسی اپراتورها (مثلاً صندوقدار) را به یک یا چند شعبه محدود می‌کنند.',
						'steps' => array(
							'برای هر شاخه فیزیکی فروشگاه، یک شعبه ثبت کنید.',
							'در پروفایل کاربر، شعبه(های) مجاز هر اپراتور را تنظیم کنید.',
							'بدون تعیین شعبه، دسترسی کاربر کل برند خواهد بود.',
						),
					),
					array(
