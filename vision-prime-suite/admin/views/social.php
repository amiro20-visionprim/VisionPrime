...
<div class="wrap vp-suite-wrap" dir="rtl">
	...
	<nav class="vp-tabs">
		<button type="button" class="vp-tab-btn vp-tab-active" data-tab="stats">آمار تعاملی</button>
		<button type="button" class="vp-tab-btn" data-tab="add">افزودن حساب جدید</button>
		<button type="button" class="vp-tab-btn" data-tab="accounts">حساب‌های ثبت‌شده <?php echo $accounts ? '(' . (int) count( $accounts ) . ')' : ''; ?></button>
	</nav>

	<section class="vp-tab-panel" data-tab="stats">
		<div class="vp-card">
			...
			<table class="widefat striped">
				...
				<?php foreach ( $stats as $key => $s ) : ?>
					<tr>
						...
						<td class="vp-success"><?php echo (int) $s['sent']; ?></td>
						<td class="<?php echo $s['failed'] ? 'vp-error' : ''; ?>"><?php echo (int) $s['failed']; ?></td>
	...
	<section class="vp-tab-panel" data-tab="add" hidden>
		<div class="vp-card">
	...
	<section class="vp-tab-panel" data-tab="accounts" hidden>
		<div class="vp-card">
